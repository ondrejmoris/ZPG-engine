...
void Application::run()
{
	...
	sceneBuilder.addSkyBox(std::vector<std::string>{"../Cviceni1/Resources/Imgs/left.jpg", "../Cviceni1/Resources/Imgs/right.jpg", "../Cviceni1/Resources/Imgs/top.jpg", "../Cviceni1/Resources/Imgs/bottom.jpg", "../Cviceni1/Resources/Imgs/back.jpg", "../Cviceni1/Resources/Imgs/front.jpg"});
	...
	this->mainScene->objects[1]->translate(glm::vec3(0.f, 5.f, 0.f));
	this->mainScene->objects[1]->scale(glm::vec3(2.f, 2.f, 2.f));
	this->mainScene->objects[2]->translate(glm::vec3(5.f, 5.f, 0.f));
	this->mainScene->objects[3]->translate(glm::vec3(6.f, 7.35f, 0.f));
	//this->mainScene->objects[7]->scale(glm::vec3(0.5f, 0.5f, 0.5f));
	this->mainScene->objects[3]->rotate(M_PI_2, glm::vec3(1.f, 0.f, 0.f));
	this->mainScene->objects[4]->translate(glm::vec3(5.f, 12.f, 0.f));
	this->mainScene->objects[5]->translate(glm::vec3(0.f, 5.f, 0.f));
	this->mainScene->objects[5]->scale(glm::vec3(8.f, 8.f, 8.f));

	this->mainScene->objects[6]->translate(glm::vec3(30.f, 5.1f, 0.f));
	this->mainScene->objects[6]->rotate(-M_PI_2, glm::vec3(0.f, 1.f, 0.f));
