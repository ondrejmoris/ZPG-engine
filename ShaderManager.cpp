...
void ShaderManager::initShaders() {
	...
	shaders.emplace("constant", Shader("../Cviceni1/Shader.vert", "../Cviceni1/Constant.frag"));
	shaders.emplace("lambert", Shader("../Cviceni1/Shader.vert", "../Cviceni1/Lambert.frag"));
	shaders.emplace("phong", Shader("../Cviceni1/Shader.vert", "../Cviceni1/Phong.frag"));
	shaders.emplace("blinn", Shader("../Cviceni1/Shader.vert", "../Cviceni1/Blinn.frag"));
	shaders.emplace("texture", Shader("../Cviceni1/Shader.vert", "../Cviceni1/Texture.frag"));
	shaders.emplace("skybox", Shader("../Cviceni1/SkyBox.vert", "../Cviceni1/SkyBox.frag"));
}
